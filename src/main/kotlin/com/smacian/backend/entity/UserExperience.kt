/*
 * UserExperience - JPA Entity for a user's work experience entry.
 *
 * Maps to the "user_experiences" table. Each entry belongs to exactly
...
class UserExperience {
    ...
    @field:Column(name = "organization", nullable = false, length = 100)
    var organization: String = ""

    @field:Column(name = "designation", nullable = false, length = 100)
